    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className="bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40 scroll-smooth">
        <section className="min-h-screen">
          ...
          <h3 className="text-black text-2xl py-2 dark:text-white md:text-3xl">Aku mah masih pemula. Ajarin dong puh</h3>
        ...
        <section>
          ...
          <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">I like playing Genshin Impact ! </p>
            ...
            <h3 className="text-black text-lg font-medium pt-8 pb-2">Contact Me</h3>
            <p className="text-gray-600 py-2">Personal contact & social media.</p>
            ...
            <p className="text-gray-800 py-1">Email : muhammaddinan363@gmail.com</p>
