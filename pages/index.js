      ...
      <main className="bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            <h1 className="text-2xl font-burtons">dinannn</h1>
          ...
          <h2 className="text-5xl py-2 text-teal-600 font-medium dark:text-teal-400 md:text-6xl">Dinan Legends</h2>
          <h3 className="text-2xl py-2 dark:text-white md:text-3xl">Students and developer</h3>
